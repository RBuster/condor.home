  ...
  <Disclosure v-slot="{ open }" as="nav" class="bg-inherit mb-4">
    <div class="mx-auto max-w-none px-2 sm:px-6 lg:px-8 nav-shadow border-b-zinc-200">
      <div class="flex flex-wrap justify-between lg:items-center sm:justify-start">
        <a href="/"><img class="mx-0 my-7 sm:m-7 sm:hidden" src="~/assets/images/logos/logo_sm.png" alt="Condor"></a>
        <a href="/"><img class="hidden mx-0 my-7 h-16 w-fit sm:m-7 sm:block" src="~/assets/images/logos/logo_lg.png" alt="Condor"></a>
        <div class="flex justify-self-end sm:hidden align-middle">
          <!-- Mobile menu button-->
          <DisclosureButton class="inline-flex items-center justify-center rounded-md p-2 text-gray-400">
            ...
            <div v-if="!open" class="block h-6 w-6" aria-hidden="true">
              ...
              ><path
                id="path9982-7"
                style="display:inline;fill:#e9152d;fill-opacity:1;stroke:none;stroke-width:0;stroke-dasharray:none"
              ...
              /><path
                id="path9996"
                style="fill:#fadc2e;fill-opacity:1;stroke:none;stroke-width:0;stroke-dasharray:none"
              ...
              /><path
                id="path11590"
                style="fill:#184f9e;fill-opacity:1;stroke:none;stroke-width:0;stroke-dasharray:none"
